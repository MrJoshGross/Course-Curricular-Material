...
public class Math {
    ...
    public static boolean isEven(int n){
        // TODO write code here to compute the parity of n
        return false;
    }
    ...
    public static int max(int a, int b){
        // TODO write code to return the maximum value
        return -1;
    }
    ...
    public static int centsToDollars(int n) {
        // TODO write code here to compute the dollar amount
        return -1;
    }
    ...
    public static int centsToQuarters(int n) {
        // TODO write code here to compute the quarter amount
        return -1;
    }
    ...
    public static int centsToDimes(int n) {
        // TODO write code here to compute the dime amount
        return -1;
    }
    ...
    public static int centsToNickels(int n) {
        // TODO write code here to compute the nickel amount
        return -1;
    }
    ...
    public static int triangular(int n) {
        // TODO write code here to compute T_n
        return -1;
    }
    ...
    public static int tetrahedral(int n) {
    	// TODO write code here to compute Tr_n
    	return -1;
    }
    ...
    public static int factorial(int n) {
        // TODO write code here to compute n!
        return -1;
    }
     ...
     */
    public static float distanceTo(int p1x, int p1y, int p2x, int p2y){
        return -1;
    }
    ...
    public static int fib(int n){
        // TODO write code here to compute the nth Fibonacci number
        return -1;
    }
}
